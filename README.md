...
در مورد ذخیره کارت در دیتابیس به جای session میتونیم مدل های Cart و CartItem رو تعریف کنیم که زمانی که کاربر محصولی انتخاب کرد یک آبجکت از آن در دیتابیس ساخته شود.
